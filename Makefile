# This Makefile is for the CGI::AppBuilder::Form extension to perl.
#
...
#     ABSTRACT => q[Configuration initializer]
#     AUTHOR => q[geotiger2001@yahoo.com]
#     DISTNAME => q[CGI-AppBuilder-Form-0.10.tar.gz]
#     NAME => q[CGI::AppBuilder::Form]
#     PREREQ_PM => { Test::More=>q[0.45], Test::Harness=>q[0.1], CGI::AppBuilder=>q[0.11] }
#     VERSION => q[0.1]
#     test => { TESTS=>q[t/ab_Form.t] }
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = CGI::AppBuilder::Form
NAME_SYM = CGI_AppBuilder_Form
VERSION = 0.1
...
FULLEXT = CGI/AppBuilder/Form
BASEEXT = Form
PARENT_NAME = CGI::AppBuilder
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
INST_LIBDIR      = $(INST_LIB)/CGI/AppBuilder
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CGI/AppBuilder
...
DISTNAME = CGI-AppBuilder-Form-0.10.tar.gz
DISTVNAME = CGI-AppBuilder-Form-0.10.tar.gz-0.1
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         CGI-AppBuilder-Form-0.10.tar.gz' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Configuration initializer</ABSTRACT>' >> $(DISTNAME).ppd
